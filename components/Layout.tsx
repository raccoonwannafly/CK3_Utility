...
const Layout: React.FC<LayoutProps> = ({ children, activeTab, onTabChange }) => {
  ...
  return (
    <div className="min-h-screen bg-ck3-dark text-stone-200 font-sans selection:bg-ck3-gold selection:text-white flex flex-col md:flex-row overflow-hidden">
      {/* Sidebar Navigation */}
      <nav 
        className={`
      ...
      >
        ...
        <div className="p-3 border-t border-stone-700">
             <button 
                ...
                className="w-full flex items-center justify-center p-2 text-stone-500 hover:text-ck3-gold hover:bg-stone-800 rounded transition-colors group"
             ...
             {!isCollapsed && (
                 <div className="mt-2 text-[10px] text-stone-600 text-center">
