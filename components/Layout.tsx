...
interface LayoutProps {
  ...
  onPersistentModeChange: (val: boolean) => void;
...
const Layout: React.FC<LayoutProps> = ({ children, activeTab, onTabChange, isPersistentMode, onPersistentModeChange, designSettings, onDesignSettingsChange }) => {
      ...
      >
        ...
        <div className="p-3 border-t border-stone-700 flex gap-2">
          ...
          <button
            ...
            className={`flex-shrink-0 w-9 flex items-center justify-center p-2 rounded transition-colors ${isPersistentMode ? 'text-amber-500 bg-amber-900/20' : 'text-stone-500 hover:text-white hover:bg-stone-800'}`}
            title="Settings"
          >
            <Settings size={18} />
          </button>
        ...
        <SettingsModal
          ...
          setPersistentMode={onPersistentModeChange}
